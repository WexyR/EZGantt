...
var Duration = /** @class */ (function () {
    function Duration(millis, seconds, minutes, hours, days, weeks) {
    ...
    //getters
    Duration.prototype.getWeeks = function () {
        return this.weeks;
    };
    ...
    Duration.prototype.getMillis = function () {
        return this.millis;
    };
    //setters
    Duration.prototype.setWeeks = function (weeks) {
        this.weeks = weeks;
    };
    Duration.prototype.setDays = function (days) {
        this.days = days;
        this.update_param();
    };
    ...
    Duration.prototype.setMillis = function (millis) {
        this.millis = millis;
        this.update_param();
    };
    //methods
    Duration.prototype.update_param = function () {
    ...
    Duration.prototype.add = function (d) {
    ...
    Duration.prototype.sub = function (d) {
        this.weeks -= d.getWeeks();
        this.days -= d.getDays();
        this.hours -= d.getHours();
        this.minutes -= d.getMinutes();
    ...
    Duration.prototype.is_negative = function () {
...
var EZGanttDatabase = /** @class */ (function (_super) {
    __extends(EZGanttDatabase, _super);
    /*actor: Dexie.Table<IActor, number>;
    assignment: Dexie.Table<IAssignment, number>;
    ressource: Dexie.Table<IRessource, number>;*/
    function EZGanttDatabase() {
        var _this = _super.call(this, "EZGanttDatabase") || this;
        //
    ...
    return EZGanttDatabase;
}(dexie_1["default"]));
exports.EZGanttDatabase = EZGanttDatabase;
/*
...
var blob = db["export"]().then(function (blob) {
    file_saver_1.saveAs(blob, "EZGanttDB.json");
});

},{"dexie":3,"dexie-export-import":2,"file-saver":4}],2:[function(require,module,exports){
                        ...
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                _loop_1 = function (tableName) {
                                    var table, primKey, inbound, LIMIT, emptyTableExport, emptyTableExportJson, posEndRowsArray, lastKey, mayHaveMoreRows, _loop_2, state_1;
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0:
                        ...
                        switch (_b.label) {
                            case 0:
                                _loop_1 = function (tableExport) {
                                    var tableName, table, tableSchemaStr, rows, filter, filteredRows, _a, keys, values;
                                    return __generator(this, function (_b) {
                                        switch (_b.label) {
                                            case 0:
                                                if (!tableExport.rows)
                                                    return [2 /*return*/, "break"]; // Need to pull more!
                                                if (tableExport.rows.complete && tableExport.rows.length === 0)
                                                ...
                                                rows = tableExport.rows.map(function (row) { return TSON.revive(row); });
                                                filter = options.filter;
                                                filteredRows = filter ?
                                                    tableExport.inbound ?
                            ...
                            case 4:
                                ...
                                while (dbExport.data.length > 0 && dbExport.data[0].rows && dbExport.data[0].rows.complete) {
                                    // We've already imported all rows from the first table. Delete its occurrence
                                    dbExport.data.splice(0, 1);
                                }
                                if (!(!jsonStream.done() && !jsonStream.eof())) return [3 /*break*/, 7];
                            ...
                            case 6:
                                ...
                                _b.label = 7;
                            case 7:
                                if (!jsonStream.done() && !jsonStream.eof()) return [3 /*break*/, 0];
                                _b.label = 8;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        if (!(!stream.eof() && (!stream.result.data || !stream.result.data.data))) return [3 /*break*/, 3];
...
},{"_process":8,"buffer":6,"dexie":3}],3:[function(require,module,exports){
